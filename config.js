...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~fZk0SQjI#Ub1KOM4a928h87Be2UzrhZlJwFchqO00bqsRe4GyKSc",
    ...
    OWNER_NAME: process.env.OWNER_NAME || "༒︎ ☠︎︎ ᒪᗩᗪY ᗷOՏՏ ☠︎︎ ༒︎",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺ᒪᗩᗪY-ᗷOՏՏ-MD",
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү ℓα∂у-вσѕѕ-м∂`",
